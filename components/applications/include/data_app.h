...
typedef enum
{
    ...
    DATA_TYPE_SCHEDULING_DATE_STARTED, /**< Persistent start-state for date schedules. */
    DATA_TYPE_SCHEDULING_ANGLE_STARTED, /**< Persistent start-state for angle schedules. */
